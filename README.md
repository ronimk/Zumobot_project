...
Since assignment 1 and 2 could easily reuse the same line following logic I had already implemented earlier, and since we didn't have much time left to work on the project between just the two of us, I volunteered to do both of the assignments.
